...
Функционал: Теститорвание Yandex Market
    ...
    @all @GUI @search_from
    Сценарий: Проверка поиска по цене на странице «Смартфоны» с диапазоном равным нижнему граничному значению
    ...
    @all @GUI @search_to
    Сценарий: Проверка поиска по цене на странице «Смартфоны» с диапазоном равным верхнему граничному значению
        Допустим сохранили значения полей "Цена_от" и "Цена_до"
    ...
    @all @GUI @search_rand
    Сценарий: Проверка поиска по цене на странице «Смартфоны» со случайным диапазоном
